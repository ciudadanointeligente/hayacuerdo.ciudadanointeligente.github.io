                  ...
                  callback: function(data, tabletop){
                    ...
                    $.each(tabletop.sheets(sheet).all(), function(index, row){
                      ...
                      if( row.class === 'noacuerdo' ) {
                        posture1 = '<div class="col-md-2 noacuerdo postura1"><p>'+row.postura1+posture1_twitter+'</p></div>';
                        ...
                        posture2 = '<div class="col-md-2 noacuerdo postura2"><p>'+row.postura2+posture2_twitter+'</p></div>';
                      }

                      if( row.class === 'acuerdoparcial' ) {
                        posture1 = '<div class="col-md-2 col-md-offset-1 acuerdoparcial postura1"><p>'+row.postura1+posture1_twitter+'</p></div>';
                        ...
                        posture2 = '<div class="col-md-2 acuerdoparcial postura2"><p>'+row.postura2+posture2_twitter+'</p></div>';
                      }

                      if( row.class === 'acuerdototal' ) {
                        posture1 = '<div class="col-md-2 col-md-offset-3 acuerdototal postura1"><p>'+row.postura1+posture1_twitter+'</p></div>';
                        ...
                        posture2 = '<div class="col-md-2 acuerdototal postura2"><p>'+row.postura2+posture2_twitter+'</p></div>';
                      }
